  ...
  <div class="container-fluid">
                ...
                <div class="col-xs-12 col-md-12 col-lg-12 well well-sm">
                  <form action="#" method="post" class="form-horizontal f_center" align="center">
                       <fieldset>
                          <h2>הזמנה מספר <?php echo $order['id']; ?></h2>
                              <div class="control-group">
                                  <label class="control-label">סטטוס</label>
                                  <div class="controls">
                                      <input dir="rtl" id="status" name="status" type="text" value="<?php echo $order['status']; ?>"
                                      class="input-xlarge">
                               ...
                               <div class="btn-group btn-group-justified">
                                  <button type="submit" name="delete_order" class="btn btn-danger" style="width: 200px;">למחוק</button>
                                  <button type="submit" name="edit_order" class="btn btn-primary" style="width: 200px;">לערוך</button>
                               </div>
                          </fieldset>
                      </form>
              </div>
