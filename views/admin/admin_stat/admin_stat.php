...
<div class="container-fluid">
            ...
            <h1 class="text-center">סטטיסטיקה</h1>
            <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>פעמים שרכשו את המוצר</th>
                      <th>פעמים שצפו במוצר</th>
                      <th>פעמים שמוצר קיבל לייק</th>
                      <th>כמות במלאי</th>
                      <th>שם מוצר</th>
                      <th>מספר מוצר</th>
                    </tr>
                  ...
                  <?php foreach ($products_admin as $products): ?>
                    <tr>
                      <td><?php echo $products['was_bought']; ?></td>
                      <td><?php echo $products['was_see']; ?></td>
                      <td><?php echo $products['likes']; ?></td>
                      <td><?php echo $products['stock']; ?></td>
                      <td><?php echo $products['name']; ?></td>
                      <td><a href="/product/<?php echo $products['id']; ?>" target="_blank"><?php echo $products['id']; ?></a></td>
                    </tr>
                  <?php endforeach; ?>
                  </tbody>
                </table>
