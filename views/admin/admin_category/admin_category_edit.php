           ...
           <fieldset>
              <h2>קטגוריה</h2>
                  <div class="control-group">
                      ...
                      <div class="controls">
                          <input dir="rtl" id="category-name" name="category-name" type="text" value="<?php echo $category['name']; ?>"
                          class="input-xlarge">
                      </div>
                      <label class="control-label">מיון</label>
                      <div class="controls">
                          <input dir="rtl" id="category-sort" name="category-sort" type="text" value="<?php echo $category['sort_order']; ?>"
                          class="input-xlarge">
                      </div>
                  </div>
                   <div class="btn-group btn-group-justified">
                      <button type="submit" name="delete_category" class="btn btn-danger" style="width: 200px;">למחוק</button>
                      <button type="submit" name="edit_category" class="btn btn-primary" style="width: 200px;">לערוך</button>
                   </div>
              </fieldset>
          </form>
        </div>
